...
var modalSelectTemplates = modalSelectTemplates || {};modalSelectTemplates['modal-template.html'] = ' <ion-modal-view class="ion-nifty-modal ionic-select-modal" ng-class="::ui.modalClass">\n' +
    '   <ion-pane class="">\n' +
    '    <ion-header-bar ng-class="::ui.headerFooterClass">\n' +
    ...
    return {
        ...
        link: function (scope, iElement, iAttrs, ngModelController, transclude) {
            ...
            scope.ui = {
                ...
                cancelButton : iAttrs.cancelButton || '取消',
